export const APIHost = process.env.NODE_ENV === 'production' ? 'https://api.peeka.ai/v1' : '/api'
...
export const duplicateEmail = '/api/public/auth/email/existence?email='
export const authEmail = '/api/public/auth/google/email?code='
